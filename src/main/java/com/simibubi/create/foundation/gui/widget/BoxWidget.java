...
public class BoxWidget extends ElementWidget {
	...
	public void doRender(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
		...
		box.withBackground(customBackground != null ? customBackground : Theme.c(Key.PONDER_BACKGROUND_TRANSPARENT))
	...
	public Key getDisabledTheme() {
		return Key.BUTTON_DISABLE;
	}

	public Key getIdleTheme() {
		return Key.BUTTON_IDLE;
	}

	public Key getHoverTheme() {
		return Key.BUTTON_HOVER;
	}

	public Key getClickTheme() {
		return Key.BUTTON_CLICK;
	}
