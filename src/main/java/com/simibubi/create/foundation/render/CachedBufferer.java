...
public class CachedBufferer {
    ...
    public static SuperByteBuffer partial(PartialModel partial, BlockState referenceState,
        ...
        return CreateClient.BUFFER_CACHE.get(PARTIAL, partial, () -> BakedModelRenderHelper.standardModelRender(partial.get(), referenceState, modelTransform.get()));
    }
    ...
    public static SuperByteBuffer partialDirectional(PartialModel partial, BlockState referenceState, Direction dir, Supplier<PoseStack> modelTransform) {
        return CreateClient.BUFFER_CACHE.get(DIRECTIONAL_PARTIAL, Pair.of(dir, partial), () -> BakedModelRenderHelper.standardModelRender(partial.get(), referenceState, modelTransform.get()));
    }
