...
public class SuperByteBuffer implements Transform<SuperByteBuffer>, TStack<SuperByteBuffer> {
	...
	public SuperByteBuffer(ByteBuffer vertexBuffer, DrawState drawState, int unshadedStartVertex) {
	...
	public SuperByteBuffer(ByteBuffer vertexBuffer, DrawState drawState) {
		int vertexCount = drawState.vertexCount();
		int stride = drawState.format().getVertexSize();
