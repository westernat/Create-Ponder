...
public class AnimateParrotInstruction extends AnimateElementInstruction<ParrotElement> {
    ...
    protected AnimateParrotInstruction(ElementLink<ParrotElement> link, Vec3 totalDelta, int ticks, BiConsumer<ParrotElement, Vec3> setter, Function<ParrotElement, Vec3> getter) {
