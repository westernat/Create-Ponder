...
public class AnimateWorldSectionInstruction extends AnimateElementInstruction<WorldSectionElement> {
    ...
    protected AnimateWorldSectionInstruction(ElementLink<WorldSectionElement> link, Vec3 totalDelta, int ticks, BiConsumer<WorldSectionElement, Vec3> setter, Function<WorldSectionElement, Vec3> getter) {
