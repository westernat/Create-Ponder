...
public class AnimateMinecartInstruction extends AnimateElementInstruction<MinecartElement> {
    ...
    protected AnimateMinecartInstruction(ElementLink<MinecartElement> link, Vec3 totalDelta, int ticks, BiConsumer<MinecartElement, Vec3> setter, Function<MinecartElement, Vec3> getter) {
